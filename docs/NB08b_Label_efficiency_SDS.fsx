...
let sliceQuantColumns quantColID frame = 
    ...
    |> Frame.mapColKeys (fun ck -> ck.Split('.') |> Array.head)
...
let plotIsotopicPattern color mzsAndintensities =
    ...
    |> Chart.combine
    |> Chart.withMarkerStyle(Size = 0, Color = Color.fromHex (Colors.toWebColor color))
...
(***condition:ipynb***)
#if IPYNB
plotIsotopicPattern Colors.Table.Office.blue examplePep1.Pattern
#endif // IPYNB
(***hide***)
plotIsotopicPattern Colors.Table.Office.blue examplePep1.Pattern |> GenericChart.toChartHTML
(***include-it-raw***)
(**
*)
...
(***condition:ipynb***)
#if IPYNB
plotIsotopicPattern Colors.Table.Office.blue examplePep2.Pattern
#endif // IPYNB
(***hide***)
plotIsotopicPattern Colors.Table.Office.blue examplePep2.Pattern |> GenericChart.toChartHTML
(***include-it-raw***)
...
plotIsotopicPattern Colors.Table.Office.orange examplePep2_Sim1.SimPattern
(***hide***)
plotIsotopicPattern Colors.Table.Office.orange examplePep2_Sim1.SimPattern |> GenericChart.toChartHTML
(***include-it-raw***)
(**
*)
let examplePep2_Sim2 = simulateFrom "LTYYTPDYVVR" 2 0.99

plotIsotopicPattern Colors.Table.Office.orange examplePep2_Sim2.SimPattern
(***hide***)
plotIsotopicPattern Colors.Table.Office.orange examplePep2_Sim2.SimPattern |> GenericChart.toChartHTML
(***include-it-raw***)
(**
...
let compareIsotopicDistributions (measured : ExtractedIsoPattern) (simulated : SimulatedIsoPattern)= 
    ...
    {|
        Plot = 
            [
            plotIsotopicPattern Colors.Table.Office.blue measured.Pattern
            plotIsotopicPattern Colors.Table.Office.orange patternSim'
            ]
            |> Chart.combine
    |}
(**
